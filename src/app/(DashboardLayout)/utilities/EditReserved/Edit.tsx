...
const Typography = dynamic(() => import('@mui/material').then(mod => mod.Typography), { ssr: false, loading: () => <div><SpinnerIcon spin style={{ fontSize: '1.5em', marginRight: '5px' }} /> Loading Typography...</div> });
const Grid = dynamic(() => import('@mui/material').then(mod => mod.Grid), { ssr: false, loading: () => <div><SpinnerIcon spin style={{ fontSize: '1.5em', marginRight: '5px' }} /> Loading Grid...</div> });
const CardContent = dynamic(() => import('@mui/material').then(mod => mod.CardContent), { ssr: false, loading: () => <div><SpinnerIcon spin style={{ fontSize: '1.5em', marginRight: '5px' }} /> Loading CardContent...</div> });
const Radio = dynamic(() => import('@mui/material').then(mod => mod.Radio), { ssr: false, loading: () => <div><SpinnerIcon spin style={{ fontSize: '1.5em', marginRight: '5px' }} /> Loading Radio...</div> });
const RadioGroup = dynamic(() => import('@mui/material').then(mod => mod.RadioGroup), { ssr: false, loading: () => <div><SpinnerIcon spin style={{ fontSize: '1.5em', marginRight: '5px' }} /> Loading RadioGroup...</div> });
const FormControlLabel = dynamic(() => import('@mui/material').then(mod => mod.FormControlLabel), { ssr: false, loading: () => <div><SpinnerIcon spin style={{ fontSize: '1.5em', marginRight: '5px' }} /> Loading FormControlLabel...</div> });
const SelectPicker = dynamic(() => import('rsuite').then(mod => mod.SelectPicker), { ssr: false, loading: () => <div><SpinnerIcon spin style={{ fontSize: '1.5em', marginRight: '5px' }} /> Loading SelectPicker...</div> });
const PageContainer = dynamic(() => import('@/app/(DashboardLayout)/components/dashboard/PageContainer'), { ssr: false, loading: () => <div><SpinnerIcon spin style={{ fontSize: '1.5em', marginRight: '5px' }} /> Loading PageContainer...</div> });
const DashboardCard = dynamic(() => import('@/app/(DashboardLayout)/components/shared/DashboardCard'), { ssr: false, loading: () => <div><SpinnerIcon spin style={{ fontSize: '1.5em', marginRight: '5px' }} /> Loading DashboardCard...</div> });
const BlankCard = dynamic(() => import('@/app/(DashboardLayout)/components/shared/BlankCard'), { ssr: false, loading: () => <div><SpinnerIcon spin style={{ fontSize: '1.5em', marginRight: '5px' }} /> Loading BlankCard...</div> });
const Input = dynamic(() => import('reactstrap').then(mod => mod.Input), { ssr: false, loading: () => <div><SpinnerIcon spin style={{ fontSize: '1.5em', marginRight: '5px' }} /> Loading Input...</div> });
const Stack = dynamic(() => import('rsuite').then(mod => mod.Stack), { ssr: false, loading: () => <div><SpinnerIcon spin style={{ fontSize: '1.5em', marginRight: '5px' }} /> Loading Stack...</div> });
const CheckPicker = dynamic(() => import('rsuite').then(mod => mod.CheckPicker), { ssr: false, loading: () => <div><SpinnerIcon spin style={{ fontSize: '1.5em', marginRight: '5px' }} /> Loading CheckPicker...</div> });
const IconButton = dynamic(() => import('rsuite').then(mod => mod.IconButton), { ssr: false, loading: () => <div><SpinnerIcon spin style={{ fontSize: '1.5em', marginRight: '5px' }} /> Loading IconButton...</div> });
const ButtonToolbar = dynamic(() => import('rsuite').then(mod => mod.ButtonToolbar), { ssr: false, loading: () => <div><SpinnerIcon spin style={{ fontSize: '1.5em', marginRight: '5px' }} /> Loading ButtonToolbar...</div> });
const Loader = dynamic(() => import('rsuite').then(mod => mod.Loader), { ssr: false, loading: () => <div><SpinnerIcon spin style={{ fontSize: '1.5em', marginRight: '5px' }} /> Loading Loader...</div> });
const AddOutlineIcon = dynamic(() => import('@rsuite/icons/AddOutline'), { ssr: false, loading: () => <div><SpinnerIcon spin style={{ fontSize: '1.5em', marginRight: '5px' }} /> Loading AddOutlineIcon...</div> });
const DateRangePicker = dynamic(() => import('rsuite').then(mod => mod.DateRangePicker), { ssr: false, loading: () => <div><SpinnerIcon spin style={{ fontSize: '1.5em', marginRight: '5px' }} /> Loading DateRangePicker...</div> });
const TimeRangePicker = dynamic(() => import('rsuite').then(mod => mod.TimeRangePicker), { ssr: false, loading: () => <div><SpinnerIcon spin style={{ fontSize: '1.5em', marginRight: '5px' }} /> Loading TimeRangePicker...</div> });
const Dialog = dynamic(() => import('@mui/material').then(mod => mod.Dialog), { ssr: false, loading: () => <div><SpinnerIcon spin style={{ fontSize: '1.5em', marginRight: '5px' }} /> Loading Dialog...</div> });
const DialogActions = dynamic(() => import('@mui/material').then(mod => mod.DialogActions), { ssr: false, loading: () => <div><SpinnerIcon spin style={{ fontSize: '1.5em', marginRight: '5px' }} /> Loading DialogActions...</div> });
const DialogContent = dynamic(() => import('@mui/material').then(mod => mod.DialogContent), { ssr: false, loading: () => <div><SpinnerIcon spin style={{ fontSize: '1.5em', marginRight: '5px' }} /> Loading DialogContent...</div> });
const DialogTitle = dynamic(() => import('@mui/material').then(mod => mod.DialogTitle), { ssr: false, loading: () => <div><SpinnerIcon spin style={{ fontSize: '1.5em', marginRight: '5px' }} /> Loading DialogTitle...</div> });
const Button = dynamic(() => import('@mui/material').then(mod => mod.Button), { ssr: false, loading: () => <div><SpinnerIcon spin style={{ fontSize: '1.5em', marginRight: '5px' }} /> Loading Button...</div> });
...
const Edit: React.FC<BtnServesProps> = ({
  label = "Create",
  onClick = () => {},
  isLoading = false,
}) => {
  ...
  const handlePut = async () => {
    ...
    if (
      ...
      setLoading(true);
      setNotificationMessage("กำลังแก้ไขข้อมูล...");
      ...
      // ส่งข้อมูลไปยัง API
      const response = await fetch("/api/putdata", {
        method: "PUT",
        headers: {
      ...
      if (response.ok) {
        ...
        if (emailResponse.ok) {
          setNotificationMessage("แก้ไขข้อมูลสำเร็จ!");
  ...
  return (
    ...
    <PageContainer title="Typography" description="this is Typography">
      ...
      <Grid item sm={12} >
        ...
        <DashboardCard title=" * แก้ไข * บันทึกการจองห้องประชุม" >
              ...
              <BlankCard>
                <CardContent>
                  ...
                  >
                    ...
                    >
                      {notificationMessage === "แก้ไขข้อมูลสำเร็จ!" ? (
                        <Button
                        onClick={() => {
                          setConfirmationModalOpen(false); // ปิด Dialog
                          router.push('/utilities/userRerserved'); // ใช้ router.push จาก Next.js เพื่อนำทางไปยังหน้าใหม่
                        }}
                        color="primary"
                      >
                        OK
